...
import com.qq.engine.utils.collections.Quaternion;
...
public class Matrix4 implements Serializable {
	...
	public void memcpy(float[] mata, float[] matb, int count)
	{
		if (count > mata.length || count > matb.length)
		{
			Debug.e("Matrix4 memcpy mata length < count or matb length < count count=" + count + " mata length=" + mata.length + " matb length=" + matb.length);
			return;
		}
